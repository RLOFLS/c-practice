...
int main()
{
    ...
    Shader cubeShader("demo8_cube.vert", "demo8_cube.frag");
    ...
    unsigned int cubeTotal = 36;
    glm::mat4 *cubeInstances;
    cubeInstances = new glm::mat4[cubeTotal];
    int idx = 0;
    for (int radians = 0; radians < 360; radians += 10)
    {
        glm::mat4 model = glm::mat4(1.0f);
        
        model = glm::translate(model, glm::vec3(sin(glm::radians((float)radians)) * 10, cos(glm::radians((float)radians)) * 10, 0.0));
        model = glm::rotate(model, glm::radians(-(float)radians), glm::vec3(0.0, 0.0, 1.0));
        cubeInstances[idx++] = model;
    }
    unsigned int instanceVBO;
    glGenBuffers(1, &instanceVBO);
    glBindBuffer(GL_ARRAY_BUFFER, instanceVBO);
    glBufferData(GL_ARRAY_BUFFER, cubeTotal * sizeof(glm::mat4), &cubeInstances[0], GL_STATIC_DRAW);
   ...
   // glBindVertexArray(0);
    ...
    while (! glfwWindowShouldClose(window)) {
        ...
        glDrawArraysInstanced(GL_TRIANGLES,0, 36, cubeTotal);
        glBindVertexArray(0);
