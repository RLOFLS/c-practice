...
int main()
{
    ...
    Shader shader("demo5_shader.vert", "demo5_shader.frag");
    Shader screenShader("demo5_screen.vert", "demo5_screen.frag");
    Shader skyShader("demo6_sky.vert", "demo6_sky.frag");
